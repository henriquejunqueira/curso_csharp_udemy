...
namespace Exercicio01 {
    class Program {
        static void Main(String[] args) {
            ...
            Console.WriteLine("Mesa de escritório, cujo preço é $ {0:F2}", preco2);
            ...
            Console.WriteLine("Separador decimal invariant culture: {F3}", medida.ToString(CultureInfo.InvariantCulture));
        }
    }
}
